...
from super_doodle.doodle import DoodleWindow
...
class ControlPanel(wx.Panel):
    ...
    def __init__(self, parent, ID, doodle):
        ...
        self.clrBtns[colours[list(keys)[0]]].SetToggle(True)
    ...
    def OnPaint(self, event):
        ...
        if self.colour:
            ...
            if 1:
                ...
                _focusIndPen  = wx.Pen(self.colour, self.thickness, wx.USER_DASH)
                _focusIndPen.SetDashes([10,10])
                _focusIndPen.SetCap(wx.CAP_BUTT)            
            #dc.BeginDrawing()
            dc.SetBrush(wx.TRANSPARENT_BRUSH)
            dc.SetPen(_focusIndPen)
